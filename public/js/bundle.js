...
addEventListener('load', (e) => {
    ...
    LIST FI-WIP BUYER-NO. BUYER-FIRST BUYER-LAST BUYER-STREET BUYER-CITY BUYER-STATE BUYER-ZIP BUYER-PHONE1 BUYER-PHONE2 BUYER.CELL&nbsp
    <br /> 427.1 BLOCK.EMAIL BLOCK.MAIL SOLD LAST-SERVICE PLC FINANCE-CO CASH-P FINANCE-TOTAL CASH-D MONTHLY-PMT APR-FULL TERM&nbsp  
    <br /> SERIAL-NEW MAKE-NEW MODEL-NEW STOCK-NO. NEW/USED VEH-YR2 MILEAGE SALESMAN<br /><br /><br /><br />`

    messageThree.innerHTML = `SSELECT NAME-FILE WITH MAKE EQ "BMW" AND WITH SOLD EQ "" AND WITH LAST-SERVICE NE "" AND WITH LAST-SERVICE GE "${formatDate}"<br /><br />
    ...
    messageFive.innerHTML = `SSELECT NAME-FILE WITH SOLD EQ "" AND WITH LAST-SERVICE NE "" AND WITH LAST-SERVICE GE "${formatDate}"<br /><br />

    LIST NAME-FILE NAME1.COMPANY NAME1.FIRST NAME1.LAST ADDRESS ADDRESS2 CITY STATE ZIP.10 HOME.PHONE WORK.PHONE&nbsp 
    <br />CELLULAR EMAIL BLOCK.PHONE BLOCK.EMAIL BLOCK.MAIL SOLD LAST-SERVICE SERIAL MAKE MODEL YEAR<br /><br /><br /><br />`

    messageSix.innerHTML = `SSELECT NAME-FILE WITH SOLD EQ "${formatDate}" AND LAST-SERVICE NE "" AND WITH LAST-SERVICE GE "${formatDate}" OR WITH SOLD GE "${formatDate}"<br /><br />
