...
addEventListener('load', (e) => {
    ...
    messageSix.innerHTML = `SSELECT NAME-FILE WITH SOLD GE "${formatDate}" AND LAST-SERVICE NE "" AND WITH LAST-SERVICE GE "${formatDate}" OR WITH SOLD GE "${formatDate}"<br /><br />
